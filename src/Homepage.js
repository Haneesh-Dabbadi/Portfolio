  ...
  return (
    <div className='totalbg'>
        ...
        <div ref={homeRef} className='home d-flex'>
          ...
          <p>I'm a student passionate about Full Stack Web Development, specializing in the MERN stack.
          Skilled in React.js, Node.js, MongoDB, and Express.js.</p>
          </div>
          <div className='homepic'>
            <img className='homeimage' src={dhoni}/>
          </div>
        </div>
        <hr/>
        <div ref={aboutRef} className='aboutme'>
          <h1>About Me</h1>
          <p className='aboutmatter'>I'm currently a dedicated 4th-year student pursuing my B.Tech in Electronics and Communication Engineering, with a strong focus on Full Stack Web Development. I specialize in the MERN stack, working with React.js, Node.js, MongoDB, and Express.js to build dynamic and responsive web applications. Alongside web development, I have a keen interest in VLSI design and Embedded Systems, where I explore how hardware and software integrate to create efficient digital solutions. This combination of skills allows me to contribute to both software development and low-level hardware projects, delivering versatile and scalable results.</p>
          <h2>Download RESUME</h2>
          <h4>Skills:<p className='skill'>MERN stack</p><p className='skill'>Python</p><p className='skill'>MySQL</p><p className='skill'>Prompt Engineering</p></h4>
        </div>
        <hr/>
        ...
        <div ref={projectRef} className='projects'>
          ...
          <img className='votingimg' src={voting}/>
          <div className='middle'>
          <a href="https://github.com/Haneesh-Dabbadi/Verilog-HDL-for-Designing-of-digital-Voting-machine"><button className='probutton'>Visit</button></a>
          </div>
        ...
        <div ref={galleryRef} className='gallery'>
          ...
          <Carousel className='carousel'>
            <Carousel.Item interval={2000}>
              <img src={image1} onClick={()=> handleClickImage(image1)} />
            </Carousel.Item>
            <Carousel.Item interval={2000}>
              <img src={image2} onClick={()=> handleClickImage(image2)} />
            </Carousel.Item>
            <Carousel.Item interval={2000}>
              <img src={image3} onClick={()=> handleClickImage(image3)}/>
            </Carousel.Item>
            <Carousel.Item interval={2000}>
              <img src={image4} onClick={()=> handleClickImage(image4)}/>
            </Carousel.Item>
            <Carousel.Item interval={2000}>
              <img src={image5} onClick={()=> handleClickImage(image5)}/>
            </Carousel.Item>
            <Carousel.Item interval={2000}>
              <img src={image6} onClick={()=> handleClickImage(image6)}/>
            </Carousel.Item>
            <Carousel.Item interval={2000}>
              <img src={image7} onClick={()=> handleClickImage(image7)}/>
            </Carousel.Item>
            <Carousel.Item interval={2000}>
              <img src={image8} onClick={()=> handleClickImage(image8)}/>
            </Carousel.Item>
          </Carousel>
        </div>
        ...
        <div ref={contactRef} className='contact'>
          ...
          <div className='phonecall d-flex'>
            <img src={phonecall} className='phone'/>
            <p className='con'>+91 7702693774</p>
          </div>
          <div className='email d-flex'>
            <img src={email} className='emai'/>
